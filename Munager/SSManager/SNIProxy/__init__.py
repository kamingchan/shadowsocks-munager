...
'''
        port_list = '\n'.join(map(lambda port, domain: '%s 127.0.0.1:%s' % (domain, port), self.ports.items()))
    ...
    def _write_configuration_file(self):
        ...
        self.logger.info('write configuration file succeed.')
    ...
    def add(self, port, domain):
        self.ports[port] = domain
